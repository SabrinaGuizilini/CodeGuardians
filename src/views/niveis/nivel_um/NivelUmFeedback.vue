    ...
    <div class="container_conteudo">
      ...
      <div class="correcoes">
        ...
        <div class="correcao-fase" v-if="faseIndex === 0">
            ...
            <div class="resolucao-esperada">
              ...
              <div class="resolucao-esperada-container">
                <div class="validas-container">
                  ...
                  <div class="opcoes">
                    <p>Senha correta (ger995)</p>
                    <p>Senha preenchida</p>
                  </div>
                </div>
          ...
          <p class="regra-pont"><b>*Regra da pontuação (missões de 1 a 4):</b> +30 pontos se a resolução completa da fase de uso dos critérios da técnica funcional estiver correta.</p>
        </div>
                    ...
                    <div class="CTs">
                      <div class="CT">
                        <div class="entrada-saida">
                          <p>Senha = ger995</p>
                          <p>Geradores ativados com sucesso</p>
                        </div>
                      </div>

                      <div class="CT">
                        <div class="entrada-saida">
                          <p>Senha = a OU Senha = abcdefg1234</p>
                          <p>Geradores não ativados e mensagem 'Senha incorreta!'</p>
                        </div>
                      </div>
                      ...
                      <div class="CT">
                        <div class="entrada-saida">
                          <p>Senha = ' ' (vazia)</p>
                          <p>Geradores não ativados e mensagem 'Você deve inserir uma senha para ativar os geradores!'</p>
                        </div>
                      </div>
          ...
          <div class="respostas">
            <div class="resolucao-esperada">
              ...
              <p>Senha incorreta ativa os geradores</p>
            </div>

            <div class="sua-resolucao">
              <h1>Falhas encontradas ({{qtd_falhas_encontradas}}/1)</h1>
               <p v-if="encontrou_falha">Senha incorreta ativa os geradores</p>
            </div>
      ...
      <router-link to='/nivel-dois-apresentacao'><img src="@/assets/img/seta-2.svg" alt="proxima tela" id="proxima-tela"></router-link>
    </div>
  </div>
</template>
...
export default {
  name: 'NivelUmFeedback',
  data() {
    var pontuacao = store.pontuacaoJogador.pont_fases_niveis[0][0] + store.pontuacaoJogador.pont_fases_niveis[0][1] + store.pontuacaoJogador.pont_fases_niveis[0][2];

    pontuacao = pontuacao < 0 ? 0 : pontuacao;

    const pont_fase_um = store.pontuacaoJogador.pont_fases_niveis[0][0];
    const pont_fase_dois = store.pontuacaoJogador.pont_fases_niveis[0][1];
    const pont_fase_tres = store.pontuacaoJogador.pont_fases_niveis[0][2];
    const acertou = store.pontuacaoJogador.pont_fases_niveis[0][0] != 0 ? true : false;
    const encontrou_falha = store.pontuacaoJogador.pont_fases_niveis[0][2] != 0 ? true : false;

    const qtd_falhas_encontradas = encontrou_falha === true ? '1' : '0';

    const mensagem_feedback = pontuacao >= 50
