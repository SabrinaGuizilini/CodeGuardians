    ...
    <div class="container_conteudo">
      ...
      <div class="correcoes">
        ...
        <div class="correcao-fase" v-if="faseIndex === 0">
          ...
          <p class="diretriz-utilizada um primeira"><b>Diretrizes utilizadas:</b> Particionamento de Equivalência: se uma condição de entrada (ou saída) especifica uma quantidade de valores, são definidas uma classe válida e duas inválidas. || Análise do Valor Limite: se uma condição de entrada especifica uma quantidade de valores, devem ser definidos casos de teste para: o número minímo de valores, o número máximo de valores, o número de valores logo abaixo do mínimo e o número de valores logo acima do máximo.</p>
                    ...
                    <div class="CTs">
                      <div class="CT">
                        <div class="entrada-saida">
                          <p>Qtd. de interrupções = -18 OU Qtd. de interrupções = -10</p>
                      ...
                      <div class="CT">
                       ...
                       <div class="CT">
                        <div class="entrada-saida">
                          <p>Qtd. de interrupções = 1 OU Qtd. de interrupções = 2</p>
                          <p>Código 0</p>
                        </div>
                      </div>
          ...
          <div class="respostas">
            <div class="resolucao-esperada">
              ...
              <p>Quando há 4 interrupções, o código retornado é 0</p>
            </div>

            <div class="sua-resolucao">
              <h1>Falhas encontradas ({{qtd_falhas_encontradas}}/1)</h1>
               <p v-if="encontrou_falha">Quando há 4 interrupções, o código retornado é 0</p>
            </div>
      ...
      <router-link to='/nivel-tres-apresentacao'><img src="@/assets/img/seta-2.svg" alt="proxima tela" id="proxima-tela"></router-link>
    </div>
  </div>
</template>
...
export default {
  name: 'NivelDoisFeedback',
  data() {
    var pontuacao = store.pontuacaoJogador.pont_fases_niveis[1][0] + store.pontuacaoJogador.pont_fases_niveis[1][1] + store.pontuacaoJogador.pont_fases_niveis[1][2];

    pontuacao = pontuacao < 0 ? 0 : pontuacao;

    const pont_fase_um = store.pontuacaoJogador.pont_fases_niveis[1][0];
    const pont_fase_dois = store.pontuacaoJogador.pont_fases_niveis[1][1];
    const pont_fase_tres = store.pontuacaoJogador.pont_fases_niveis[1][2];
    const acertou = store.pontuacaoJogador.pont_fases_niveis[1][0] != 0 ? true : false;
    const encontrou_falha = store.pontuacaoJogador.pont_fases_niveis[1][2] != 0 ? true : false;

    const qtd_falhas_encontradas = encontrou_falha === true ? '1' : '0';

    const mensagem_feedback = pontuacao >= 70
