       ...
       <div class="exercicio-avl">
          ...
          <div class="container-valores-limite">
            ...
            <div v-if="correcao_realizada" ref="correcoes1" class="correcoes">
              ...
              <p v-if="!resp1_correta" class="resposta-certa">0 OU 51</p>
            </div>
          </div>
          ...
          <div class="container-valores-limite">
            <select name="valores-limite" class="valores-limite" v-model="select2">
             ...
             <div v-if="correcao_realizada" ref="correcoes2" class="correcoes">
              ...
              <p v-if="!resp2_correta" class="resposta-certa">1 OU 50</p>
            </div>
          </div>
          ...
          <div class="container-valores-limite">
            <select name="valores-limite" class="valores-limite" v-model="select3">
             ...
             <div v-if="correcao_realizada" ref="correcoes3" class="correcoes">
              ...
              <p v-if="!resp3_correta" class="resposta-certa">50 OU 1</p>
            </div>
          </div>
          ...
          <div class="container-valores-limite">
            <select name="valores-limite" class="valores-limite" v-model="select4">
             ...
             <div v-if="correcao_realizada" ref="correcoes4" class="correcoes">
              ...
              <p v-if="!resp4_correta" class="resposta-certa">51 OU 0</p>
            </div>
          </div>
...
export default {
  ...
  components: {
   ...
   computed: {
    ...
    methods: {
    validaResp1() {
      this.resp1_correta = (this.select1 === "zero" || this.select1 === "cinquenta-um");
    },
    validaResp2() {
     this.resp2_correta = (this.select2 === "um" || this.select2 === "cinquenta");
    },
    validaResp3() {
      this.resp3_correta = (this.select3 === "cinquenta" || this.select3 === "um");
    },
     validaResp4() {
      this.resp4_correta = (this.select4 === "cinquenta-um" || this.select4 === "zero");
    },
