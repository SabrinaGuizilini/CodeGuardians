      ...
      <div class="exercicio-particao">
        ...
        <div class="particao">
          ...
          <div v-if="correcao_realizada" ref="correcoes1" class="correcoes">
            ...
            <p v-if="!resp1_correta" class="resposta-certa">Correção: Qtd. caracteres &lt; 1 <br> OU Qtd. caracteres > 6</p>
          </div>
        </div>
        ...
        <div class="particao">
          ...
          <select name="particoes" class="particoes-select" v-model="select2">
            ...
            <div v-if="correcao_realizada" ref="correcoes2" class="correcoes">
              ...
              <p v-if="!resp2_correta" class="resposta-certa">Correção: Qtd. caracteres >= 1 <br /> e &lt;= 6</p>
          </div>
        </div>
        ...
        <div class="particao">
          ...
          <select name="particoes" class="particoes-select" v-model="select3">
            ...
            <div v-if="correcao_realizada" ref="correcoes3" class="correcoes">
              ...
              <p v-if="!resp3_correta" class="resposta-certa">Correção: Qtd. caracteres > 6 <br> OU Qtd. caracteres &lt; 1</p>
          </div>
        </div>
...
export default {
  ...
  components: {
   ...
   data() {
    return {
      currentDotIndex: 2,
      link_prox: "/diretriz-tres",
      link_ant: "/diretriz-um",
      textos: [
        '<span class="destacado">Diretriz 2</span> - Se uma condição de entrada (ou saída) especifica uma <span class="destacado">quantidade de valores</span>, são definidas <span class="destacado">uma classe válida</span> e <span class="destacado">duas inválidas</span>.',
        '<span class="destacado">Exemplo prático:</span> Um campo de cadastro de senha só deve aceitar senhas que tenham de 1 a 6 caracteres. Selecione a opção correta para as classes válidas e inválidas:'
      ],
      select1: "default",
      select2: "default",
      select3: "default",
      ...
      isClicked: false,
      options: [
        { value: "invalida_maior", label: "Qtd. caracteres > 6" },
        { value: "valida", label: "Qtd. caracteres >= 1 e <= 6" },
        { value: "invalida_menor", label: "Qtd. caracteres < 1" },
      ],
    };
  },
  computed: {
  ...
  methods: {
    ...
    validaResp3() {
      this.resp3_correta = (this.select3 === "invalida_maior" || this.select3 === "invalida_menor");
    },
